...
#ifndef __ANYTIME_DUAL_QUEUE_MULTIPLE_HEURISTIC_BEST_FIRST_SEARCH__WITH_TRACE__
#define __ANYTIME_DUAL_QUEUE_MULTIPLE_HEURISTIC_BEST_FIRST_SEARCH__WITH_TRACE__
...
namespace search {
  ...
  namespace bfs_dq_mh {
    ...
    public:
      ...
      AT_BFS_DQ_MH_TRACER( 	const Search_Model& search_problem )
